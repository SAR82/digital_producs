    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.BigIntegerField(validators=[utils.validators.validate_sku], verbose_name='phone number')),
                ...
                ('gateway', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='payments.gateways', verbose_name='gateway')),
